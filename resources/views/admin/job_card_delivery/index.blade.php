...
@section('content')
    <div class="card-head-icon">
        <i class='bx bxs-truck' style="color: rgb(0, 33, 218);"></i>
        <div>Job Card Delivery</div>
    </div>
        ...
        <div class="card-body">
            <table class="table table-bordered table-striped w-100" id="DataTable">
                <thead>
                    ...
                    <th>Delivery Date</th>
                    <th class="no-sort text-nowrap">Complete</th>
                </thead>
                <tbody>
...
@section('scripts')
    <script src="{{asset('js/job_card_delivery.js')}}"></script>
@endsection
